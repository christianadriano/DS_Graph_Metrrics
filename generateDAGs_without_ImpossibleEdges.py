"""
Generate all possible DAGs for a given number of nodes
Remove the DAGs that present impossible edges

Inspired on https://www.techiedelight.com/find-all-possible-topological-orderings-of-dag/
...
def removeImpossibleEdges(edgeList)
    #TODO
